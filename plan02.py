...
with open('commands.txt', 'w') as f:
    ...
    for i in range(length):
        ...
        if list[i].find("MOVE ROBOT") != (-1) :
            ...
            tmp_line = "self.id = bot.move_absolute(x=A["+point+"][0], y=A["+point+"][1], z=A["+point+"][2]-300)"\
                +"\n"+'print("MOVE_ABS REQUEST ID: " + self.id)' +"\n"
            f.write(tmp_line)
    
            tmp_line = "self.id = bot.move_absolute(x=A["+point+"][0], y=A["+point+"][1], z=A["+point+"][2]-510)"\
                +"\n"+'print("MOVE_ABS REQUEST ID: " + self.id)' + "\n"
            f.write(tmp_line)
            ...
            tmp_line = "self.id = bot.move_absolute(x=A["+point+"][0], y=A["+point+"][1], z=A["+point+"][2]-510)"\
                +"\n"+'print("MOVE_ABS REQUEST ID: " + self.id)' + "\n"
            f.write(tmp_line)
            tmp_line = "self.id = bot.move_absolute(x=A["+point+"][0], y=A["+point+"][1], z=A["+point+"][2]-400)"\
                +"\n"+'print("MOVE_ABS REQUEST ID: " + self.id)' + "\n"
            f.write(tmp_line)
        ...
        # using the space after "WATER " to differentiate it from MOUNT-WATERNOZZLE WATERINGNOZZLE
            ...
            tmp_line = "self.id = bot.move_absolute(x=A["+point+"][0], y=A["+point+"][1], z=A["+point+"][2]-200)"\
                +"\n"+'print("MOVE_ABS REQUEST ID: " + self.id)' +"\n"
            f.write(tmp_line)
            tmp_line = "self.id = bot.move_absolute(x=A["+point+"][0], y=A["+point+"][1]+30, z=A["+point+"][2]-200)"\
                +"\n"+'print("MOVE_ABS REQUEST ID: " + self.id)' +"\n"\
                + "self.id = bot.move_absolute(x=A["+point+"][0], y=A["+point+"][1]-30, z=A["+point+"][2]-200)"\
                +"\n"+'print("MOVE_ABS REQUEST ID: " + self.id)' +"\n"\
                + "self.id = bot.move_absolute(x=A["+point+"][0], y=A["+point+"][1], z=A["+point+"][2]-200)"+"\n"
